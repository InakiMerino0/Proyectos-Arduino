Introducción
Nuestro proyecto final tiene como propósito la medición de datos atmosféricos para su muestreo al usuario mediante una página asociada al prototipo. Esto con el fin de poder advertir a los usuarios de las condiciones atmosféricas del ambiente en cualquier momento y lugar. En este informe se mostrará el proceso por el que pasamos los integrantes y el proyecto hasta su culminación.
...
Para el maquetado de la página se utilizó Html5, sumado a la librería de bootstrap, de donde se sacaron los templates para el diseño de la página, a dichos templates se les modificó el diseño mediante los parámetros class o sass(framework de CSS).
Para las pequeñas modificaciones de diseño se utilizó CSS, un lenguaje de diseño y estética para dar estilo a una maqueta de la página.
